    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="${cssMenu}"><a href="<spring:url value="/customers" htmlEscape="true" />"><span class="glyphicon glyphicon-search" aria-hidden="true"></span><span> Customers</span></a></li>
                <c:choose>
                ...
                <li class="${cssMenu}"><a href="<spring:url value="/catalogue" htmlEscape="true" />"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span><span> Products</span></a></li>
<!--                <c:choose>
