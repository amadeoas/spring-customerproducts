...
<%--
CustomerProducts :: a Spring Framework demonstration
--%>
...
<head>
    ...
    <title>CustomerProducts :: a Spring Framework demonstration</title>

    <%-- CSS generated from LESS --%>
    <spring:url value="/resources/css/customerproducts.css" var="customerproductsCss"/>
    <link href="${customerproductsCss}" rel="stylesheet"/>
